...
func (m *MockClient) McpServerStatus(ctx context.Context) ([]shared.McpServerStatus, error) {
	return nil, nil
}

func (m *MockClient) SetMcpServers(ctx context.Context, servers map[string]shared.McpServerConfig) (*shared.McpSetServersResult, error) {
	return &shared.McpSetServersResult{
		Added:   []string{},
		Removed: []string{},
